    ...
    > {
        ...
        if capability == capabilities[3].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ResumeSessionRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::AgentHostDispatch::resume_session(
                        &self.service,
                        context,
                        input,
                    )
        ...
        if capability == capabilities[4].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ForkSessionRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::AgentHostDispatch::fork_session(
                        &self.service,
                        context,
                        input,
                    )
        ...
        if capability == capabilities[10].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::DetachSessionsRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::AgentHostDispatch::detach_sessions(
                        &self.service,
                        context,
                        input,
                    )
