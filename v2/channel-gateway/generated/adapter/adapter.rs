...
#[doc(hidden)]
pub struct ChannelGatewayAdapter<T> {
    service: T,
...
) -> ChannelGatewayAdapter<T>
where
    T: ::boxology_generated_contract::ChannelGatewayDispatch + Send + Sync + 'static,
{
...
where
    T: ::boxology_generated_contract::ChannelGatewayDispatch + Send + Sync + 'static,
    F: FnOnce(ChannelGatewayImports) -> T,
{
    composition
        .register(
...
impl NativeChannelImport {
    ...
    pub async fn recover_session(
        &self,
        context: ::boxology_contract::CallContext,
        input: ::boxology_import_native_channel::RecoverSessionRequest,
    ) -> Result<
        ::boxology_import_native_channel::ChannelBinding,
        ::boxology_contract::ErasedCallError,
    > {
    ...
    pub async fn list_bindings(
        &self,
        context: ::boxology_contract::CallContext,
        input: ::boxology_import_native_channel::ListChannelBindingsRequest,
    ) -> Result<
        ::boxology_import_native_channel::ChannelBindingCatalog,
        ::boxology_contract::ErasedCallError,
    > {
        let capability = ::boxology_contract::CapabilityId::new(
            ::boxology_contract::BoxId::new("native-channel")
        ...
        <::boxology_import_native_channel::ChannelBindingCatalog as ::boxology_contract::ContractType>::decode(
                &output,
            )
            .map_err(|error| {
                ::boxology_contract::ErasedCallError::InvalidResponse(
    ...
    pub async fn list_binding_page(
        &self,
        context: ::boxology_contract::CallContext,
        input: ::boxology_import_native_channel::ListChannelBindingPageRequest,
    ) -> Result<
        ::boxology_import_native_channel::ChannelBindingCatalogPage,
        ::boxology_contract::ErasedCallError,
    > {
        let capability = ::boxology_contract::CapabilityId::new(
            ::boxology_contract::BoxId::new("native-channel")
        ...
        <::boxology_import_native_channel::ChannelBindingCatalogPage as ::boxology_contract::ContractType>::decode(
                &output,
            )
            .map_err(|error| {
                ::boxology_contract::ErasedCallError::InvalidResponse(
    ...
    pub async fn locate_binding_summaries(
        &self,
        context: ::boxology_contract::CallContext,
        input: ::boxology_import_native_channel::LocateChannelBindingSummariesRequest,
    ) -> Result<
        ::boxology_import_native_channel::LocatedChannelBindingSummaries,
        ::boxology_contract::ErasedCallError,
    > {
        let capability = ::boxology_contract::CapabilityId::new(
            ::boxology_contract::BoxId::new("native-channel")
        ...
        <::boxology_import_native_channel::LocatedChannelBindingSummaries as ::boxology_contract::ContractType>::decode(
                &output,
            )
            .map_err(|error| {
                ::boxology_contract::ErasedCallError::InvalidResponse(
    ...
    pub async fn binding_summary(
        ...
        ::boxology_import_native_channel::ChannelBindingSummary,
        ::boxology_contract::ErasedCallError,
    > {
        let capability = ::boxology_contract::CapabilityId::new(
            ::boxology_contract::BoxId::new("native-channel")
        ...
        <::boxology_import_native_channel::ChannelBindingSummary as ::boxology_contract::ContractType>::decode(
                &output,
            )
            .map_err(|error| {
                ::boxology_contract::ErasedCallError::InvalidResponse(
...
pub struct ChannelGatewayImports {
    pub agent_host: AgentHostImport,
    pub native_channel: NativeChannelImport,
}
pub fn typed_imports(imports: &::boxology_runtime::Imports) -> ChannelGatewayImports {
    ChannelGatewayImports {
...
impl<T> ::boxology_contract::ErasedTarget for ChannelGatewayAdapter<T>
where
    T: ::boxology_generated_contract::ChannelGatewayDispatch + Send + Sync + 'static,
{
    fn call<'a>(
    ...
    > {
        let expected = ::boxology_generated_contract::contract_descriptor()
            .capabilities()
            .first()
            .expect("generated ChannelGateway contract has one capability")
            .id();
        ...
        Box::pin(async move {
            ...
            let input = <::boxology_generated_contract::AttachChannelRequest as ::boxology_contract::ContractType>::decode(
                    &input,
                )
                .map_err(|error| {
                    ::boxology_contract::ErasedCallError::ContractViolation(
            ...
            match ::boxology_generated_contract::ChannelGatewayDispatch::attach_channel(
                    &self.service,
                    context,
                    input,
                )
