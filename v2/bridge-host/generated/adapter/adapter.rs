    ...
    > {
        ...
        if capability == capabilities[1].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ListBridgesRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::BridgeHostDispatch::list_bridges(
                        &self.service,
                        context,
                        input,
                    )
        ...
        if capability == capabilities[2].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ListBridgePageRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::BridgeHostDispatch::list_bridge_page(
                        &self.service,
                        context,
                        input,
                    )
        ...
        if capability == capabilities[12].id() {
            return Box::pin(async move {
                ...
                let input = <::boxology_generated_contract::ImportBridgeContentRequest as ::boxology_contract::ContractType>::decode(
                        &input,
                    )
                    .map_err(|error| {
                        ::boxology_contract::ErasedCallError::ContractViolation(
                ...
                match ::boxology_generated_contract::BridgeHostDispatch::import_content(
                        &self.service,
                        context,
                        input,
                    )
        ...
        if capability == capabilities[17].id() {
            return Box::pin(async move {
                let input = ::boxology_contract::TypeDescriptor::structure([
                        ::boxology_contract::FieldDescriptor::new(
                            "bridge_id",
                ...
                match ::boxology_generated_contract::BridgeHostDispatch::suspend_bridge(
                        &self.service,
                        context,
                        input,
                    )
