...
> = ::std::sync::LazyLock::new(|| {
    ...
    let capability_10 = ::boxology_contract::CapabilityDescriptor::new(
        ::boxology_contract::CapabilityId::new(
            box_id.clone(),
            ::boxology_contract::CapabilityName::new("list_binding_page")
                .expect("generated capability name is valid"),
        ),
        ::boxology_contract::TypeDescriptor::structure([
                ::boxology_contract::FieldDescriptor::new(
    ...
    let capability_11 = ::boxology_contract::CapabilityDescriptor::new(
        ::boxology_contract::CapabilityId::new(
            box_id.clone(),
            ::boxology_contract::CapabilityName::new("locate_binding_summaries")
                .expect("generated capability name is valid"),
        ),
        ::boxology_contract::TypeDescriptor::structure([
                ::boxology_contract::FieldDescriptor::new(
    ...
    ::boxology_contract::ContractDescriptor::new(
            ...
            ::boxology_contract::ContractRevision::new(
                    "sha256:d5d21bc145671993f89bb704dd260fa09ed30268dc9febad0fa16271b55498dc",
                )
...
pub trait NativeChannelDispatch: Send + Sync + 'static {
    ...
    fn list_binding_page<'a>(
        ...
        Box<
            dyn Future<
                Output = Result<ChannelBindingCatalogPage, NativeChannelError>,
            > + Send + 'a,
        >,
    >;
    fn locate_binding_summaries<'a>(
        &'a self,
        context: CallContext,
        ...
        Box<
            dyn Future<
                Output = Result<LocatedChannelBindingSummaries, NativeChannelError>,
            > + Send + 'a,
        >,
    >;
...
impl NativeChannelHandle {
    ...
    pub async fn recover_session(
        ...
        let output = self
            .target
            .call(&NATIVE_CHANNEL_RECOVER_SESSION, context, input)
            .await
            .map_err(|error| {
                error.into_typed::<NativeChannelError>(&NATIVE_CHANNEL_ERROR_DESCRIPTOR)
            })?;
    ...
    pub async fn list_binding_page(
        ...
        context: CallContext,
        request: ListChannelBindingPageRequest,
    ) -> Result<ChannelBindingCatalogPage, CallError<NativeChannelError>> {
        let input = request
            .encode()
            .map_err(|error| conversion_detail("input_encode", error))
            .map_err(CallError::ContractViolation)?;
        let output = self
            .target
            .call(&NATIVE_CHANNEL_LIST_BINDING_PAGE, context, input)
            .await
            .map_err(|error| {
                error.into_typed::<NativeChannelError>(&NATIVE_CHANNEL_ERROR_DESCRIPTOR)
            })?;
        let output = TypeDescriptor::structure([
            ...
            .map_err(|error| conversion_detail("output_decode", error))
            .map_err(CallError::InvalidResponse)?;
        <ChannelBindingCatalogPage as ContractType>::decode(&output)
            .map_err(|error| conversion_detail("output_decode", error))
            .map_err(CallError::InvalidResponse)
    }
    pub async fn locate_binding_summaries(
        ...
        context: CallContext,
        request: LocateChannelBindingSummariesRequest,
    ) -> Result<LocatedChannelBindingSummaries, CallError<NativeChannelError>> {
        let input = request
            .encode()
            .map_err(|error| conversion_detail("input_encode", error))
            .map_err(CallError::ContractViolation)?;
        let output = self
            .target
            .call(&NATIVE_CHANNEL_LOCATE_BINDING_SUMMARIES, context, input)
            .await
            .map_err(|error| {
                error.into_typed::<NativeChannelError>(&NATIVE_CHANNEL_ERROR_DESCRIPTOR)
            })?;
        let output = TypeDescriptor::structure([
            ...
            .map_err(|error| conversion_detail("output_decode", error))
            .map_err(CallError::InvalidResponse)?;
        <LocatedChannelBindingSummaries as ContractType>::decode(&output)
            .map_err(|error| conversion_detail("output_decode", error))
            .map_err(CallError::InvalidResponse)
    }
...
#[rustfmt::skip]
static NATIVE_CHANNEL_RECOVER_SESSION: LazyLock<CapabilityId> = LazyLock::new(|| {
    CapabilityId::new(
        BoxId::new("native-channel").expect("generated box identity is valid"),
        CapabilityName::new("recover_session")
            .expect("generated capability name is valid"),
    )
});
#[rustfmt::skip]
...
#[rustfmt::skip]
static NATIVE_CHANNEL_LIST_BINDING_PAGE: LazyLock<CapabilityId> = LazyLock::new(|| {
    CapabilityId::new(
        BoxId::new("native-channel").expect("generated box identity is valid"),
        CapabilityName::new("list_binding_page")
            .expect("generated capability name is valid"),
    )
});
#[rustfmt::skip]
static NATIVE_CHANNEL_LOCATE_BINDING_SUMMARIES: LazyLock<CapabilityId> = LazyLock::new(||
{
    CapabilityId::new(
        BoxId::new("native-channel").expect("generated box identity is valid"),
        CapabilityName::new("locate_binding_summaries")
            .expect("generated capability name is valid"),
    )
});
#[rustfmt::skip]
...
#[rustfmt::skip]
impl ::boxology_contract::ContractType for RecoverSessionRequest {
    fn encode_value(
        &self,
    ) -> ::core::result::Result<
        ::boxology_contract::ContractValue,
    ...
    fn decode_value(
        ...
        for (field, _) in fields.entries() {
            match field {
                "binding_id" | "expected_session_id" => {}
                _ => {
                    return Err(
                        ::boxology_contract::DecodeError::new(
                                ::boxology_contract::DecodeErrorKind::UnknownField(
...
pub struct ChannelBindingCatalogPage {
    pub bindings: ::std::vec::Vec<ChannelBindingSummary>,
    pub total_bindings: u64,
    pub next_after_binding_id: ::core::option::Option<::std::string::String>,
}
#[rustfmt::skip]
impl ::boxology_contract::ContractType for ChannelBindingCatalogPage {
    fn encode_value(
        &self,
    ) -> ::core::result::Result<
        ::boxology_contract::ContractValue,
    ...
    > {
        ...
        if let Some(value) = ::boxology_contract::ContractType::encode_field(
                &self.next_after_binding_id,
            )
            .map_err(|error| {
                error
                    .under(
                        ::boxology_contract::PathSegment::Field(
                            "next_after_binding_id".into(),
                        ),
                    )
            })?
        {
            fields.push(("next_after_binding_id".into(), value));
        }
        ::boxology_contract::ContractValue::object(fields)
            .map_err(|_| unreachable!("validated generated field identities are unique"))
    }
    fn decode_value(
        ...
        for (field, _) in fields.entries() {
            match field {
                "bindings" | "total_bindings" | "next_after_binding_id" => {}
                _ => {
                    return Err(
                        ::boxology_contract::DecodeError::new(
                                ::boxology_contract::DecodeErrorKind::UnknownField(
        ...
        Ok(Self {
            ...
            next_after_binding_id: <::core::option::Option<
                ::std::string::String,
            > as ::boxology_contract::ContractType>::decode_field(
                    fields.get("next_after_binding_id"),
                )
                .map_err(|error| {
                    error
                        .under(
...
pub struct ListChannelBindingPageRequest {
    pub after_binding_id: ::core::option::Option<::std::string::String>,
    pub limit: u64,
    pub include_detached: bool,
}
#[rustfmt::skip]
impl ::boxology_contract::ContractType for ListChannelBindingPageRequest {
    fn encode_value(
        &self,
    ) -> ::core::result::Result<
        ::boxology_contract::ContractValue,
    ...
    > {
        let mut fields = ::std::vec::Vec::new();
        if let Some(value) = ::boxology_contract::ContractType::encode_field(
                &self.after_binding_id,
            )
            .map_err(|error| {
                error
                    .under(
                        ::boxology_contract::PathSegment::Field(
                            "after_binding_id".into(),
                        ),
                    )
            })?
        {
            fields.push(("after_binding_id".into(), value));
        }
        if let Some(value) = ::boxology_contract::ContractType::encode_field(&self.limit)
            .map_err(|error| {
                error.under(::boxology_contract::PathSegment::Field("limit".into()))
        ...
        if let Some(value) = ::boxology_contract::ContractType::encode_field(
                &self.include_detached,
            )
            .map_err(|error| {
                error
                    .under(
                        ::boxology_contract::PathSegment::Field(
                            "include_detached".into(),
                        ),
                    )
            })?
        {
            fields.push(("include_detached".into(), value));
        }
        ::boxology_contract::ContractValue::object(fields)
            .map_err(|_| unreachable!("validated generated field identities are unique"))
    }
    fn decode_value(
        ...
        for (field, _) in fields.entries() {
            match field {
                "after_binding_id" | "limit" | "include_detached" => {}
                _ => {
                    return Err(
                        ::boxology_contract::DecodeError::new(
                                ::boxology_contract::DecodeErrorKind::UnknownField(
        ...
        Ok(Self {
            after_binding_id: <::core::option::Option<
                ::std::string::String,
            > as ::boxology_contract::ContractType>::decode_field(
                    fields.get("after_binding_id"),
                )
                .map_err(|error| {
                    error
                        .under(
            ...
            include_detached: <bool as ::boxology_contract::ContractType>::decode_field(
                    fields.get("include_detached"),
                )
                .map_err(|error| {
                    error
                        .under(
...
pub struct LocateChannelBindingSummariesRequest {
    pub identities: ::std::vec::Vec<LocateBindingRequest>,
}
#[rustfmt::skip]
impl ::boxology_contract::ContractType for LocateChannelBindingSummariesRequest {
    fn encode_value(
        &self,
    ) -> ::core::result::Result<
        ::boxology_contract::ContractValue,
    ...
    > {
        ...
        if let Some(value) = ::boxology_contract::ContractType::encode_field(
            ...
            .map_err(|error| {
                error.under(::boxology_contract::PathSegment::Field("identities".into()))
            })?
        {
            fields.push(("identities".into(), value));
        }
        ::boxology_contract::ContractValue::object(fields)
            .map_err(|_| unreachable!("validated generated field identities are unique"))
    }
        ...
        Ok(Self {
            ...
            > as ::boxology_contract::ContractType>::decode_field(
                ...
                .map_err(|error| {
                    error
                        .under(
                            ::boxology_contract::PathSegment::Field("identities".into()),
                        )
                })?,
        })
    }
...
#[rustfmt::skip]
impl ::boxology_contract::ContractType for LocatedChannelBindingSummaries {
    fn encode_value(
        &self,
    ) -> ::core::result::Result<
        ::boxology_contract::ContractValue,
...
pub mod test_support {
    ...
    use super::{
        ...
        NATIVE_CHANNEL_LIST_BINDING_PAGE, NATIVE_CHANNEL_LOCATE_BINDING_SUMMARIES,
    ...
    type RecoverSessionFuture = Pin<
        ...
        >,
    >;
    type RecoverSessionResponder = dyn Fn(
        CallContext,
        super::RecoverSessionRequest,
    ) -> RecoverSessionFuture + Send + Sync + 'static;
    ...
    type ListBindingPageFuture = Pin<
        Box<
            dyn Future<
                Output = Result<super::ChannelBindingCatalogPage, NativeChannelError>,
            > + Send + 'static,
        >,
    >;
    type ListBindingPageResponder = dyn Fn(
        CallContext,
        super::ListChannelBindingPageRequest,
    ) -> ListBindingPageFuture + Send + Sync + 'static;
    type LocateBindingSummariesFuture = Pin<
        Box<
            dyn Future<
                Output = Result<
                    super::LocatedChannelBindingSummaries,
                    NativeChannelError,
                >,
            > + Send + 'static,
        >,
    >;
    type LocateBindingSummariesResponder = dyn Fn(
        CallContext,
        super::LocateChannelBindingSummariesRequest,
    ) -> LocateBindingSummariesFuture + Send + Sync + 'static;
    ...
    pub struct NativeChannelFake {
        ...
        list_binding_page: Option<Arc<ListBindingPageResponder>>,
        locate_binding_summaries: Option<Arc<LocateBindingSummariesResponder>>,
    ...
    impl NativeChannelFake {
        ...
        pub fn with_recover_session<F, Fut>(mut self, responder: F) -> Self
        where
            F: Fn(CallContext, super::RecoverSessionRequest) -> Fut + Send + Sync
                + 'static,
            Fut: Future<Output = Result<super::ChannelBinding, NativeChannelError>>
                + Send + 'static,
        {
            self.recover_session = Some(
                Arc::new(move |context, request| {
                    Box::pin(responder(context, request))
                }),
            );
        ...
        pub fn with_list_binding_page<F, Fut>(mut self, responder: F) -> Self
        where
            F: Fn(CallContext, super::ListChannelBindingPageRequest) -> Fut + Send + Sync
                + 'static,
            Fut: Future<
                    Output = Result<super::ChannelBindingCatalogPage, NativeChannelError>,
                > + Send + 'static,
        {
            self.list_binding_page = Some(
                Arc::new(move |context, request| {
                    Box::pin(responder(context, request))
                }),
            );
        ...
        pub fn with_locate_binding_summaries<F, Fut>(mut self, responder: F) -> Self
        where
            F: Fn(CallContext, super::LocateChannelBindingSummariesRequest) -> Fut + Send
                + Sync + 'static,
            Fut: Future<
                    Output = Result<
                        super::LocatedChannelBindingSummaries,
                ...
                > + Send + 'static,
        {
            self.locate_binding_summaries = Some(
                Arc::new(move |context, request| {
                    Box::pin(responder(context, request))
                }),
            );
    ...
    impl ErasedCallTarget for NativeChannelFake {
        ...
        > {
            ...
            if capability == &*NATIVE_CHANNEL_RECOVER_SESSION {
                let Some(responder) = self.recover_session.clone() else {
                    return Box::pin(ready(Err(unprogrammed())));
                };
                return Box::pin(async move {
                    let input = TypeDescriptor::structure([
                    ...
                    let request = <super::RecoverSessionRequest as ContractType>::decode(
                            &input,
                        )
                        .map_err(|error| {
                            ErasedCallError::ContractViolation(
            ...
            if capability == &*NATIVE_CHANNEL_LIST_BINDING_PAGE {
                let Some(responder) = self.list_binding_page.clone() else {
                    return Box::pin(ready(Err(unprogrammed())));
                };
                return Box::pin(async move {
                    let input = TypeDescriptor::structure([
                    ...
                    let request = <super::ListChannelBindingPageRequest as ContractType>::decode(
                            &input,
                        )
                        .map_err(|error| {
                            ErasedCallError::ContractViolation(
            ...
            if capability == &*NATIVE_CHANNEL_LOCATE_BINDING_SUMMARIES {
                let Some(responder) = self.locate_binding_summaries.clone() else {
                    return Box::pin(ready(Err(unprogrammed())));
                };
                return Box::pin(async move {
                    let input = TypeDescriptor::structure([
                    ...
                    let request = <super::LocateChannelBindingSummariesRequest as ContractType>::decode(
                            &input,
                        )
                        .map_err(|error| {
                            ErasedCallError::ContractViolation(
...
pub const __BOXOLOGY_SEMANTIC_DIGEST: [u8; 32] = [
    183, 191, 36, 93, 207, 1, 195, 112, 135, 221, 139, 21, 76, 165, 244, 190, 16, 137,
    37, 84, 201, 231, 110, 100, 147, 216, 172, 235, 103, 109, 79, 222,
];
#[rustfmt::skip]
#[doc(hidden)]
#[macro_export]
macro_rules! __boxology_check_implementation {
    ($receiver:ty; $($method:ident $validity:ident;)*) => {
        ...
        $($method $validity;)*); $crate::__boxology_check_implementation!(@
        find_list_binding_page $receiver; $($method $validity;)*);
        $crate::__boxology_check_implementation!(@ find_locate_binding_summaries
        $receiver; $($method $validity;)*); $crate::__boxology_check_implementation!(@
        ...
        ::core::marker::Send + 'a, >, > { ::std::boxed::Box::pin(self
        .replace_session(context, input)) } fn recover_session <'a > (&'a self, context :
        ::boxology::CallContext, input : $crate::RecoverSessionRequest,) ->
        ::std::pin::Pin < ::std::boxed::Box < dyn ::core::future::Future < Output =
        ::core::result::Result <$crate::ChannelBinding, $crate::NativeChannelError >, > +
        ::core::marker::Send + 'a, >, > { ::std::boxed::Box::pin(self
        .recover_session(context, input)) } fn channel_status <'a > (&'a self, context :
        ...
        ::core::marker::Send + 'a, >, > { ::std::boxed::Box::pin(self
        .list_bindings(context, input)) } fn list_binding_page <'a > (&'a self, context :
        ::boxology::CallContext, input : $crate::ListChannelBindingPageRequest,) ->
        ::std::pin::Pin < ::std::boxed::Box < dyn ::core::future::Future < Output =
        ::core::result::Result <$crate::ChannelBindingCatalogPage,
        $crate::NativeChannelError >, > + ::core::marker::Send + 'a, >, > {
        ::std::boxed::Box::pin(self.list_binding_page(context, input)) } fn
        locate_binding_summaries <'a > (&'a self, context : ::boxology::CallContext,
        input : $crate::LocateChannelBindingSummariesRequest,) -> ::std::pin::Pin <
        ::std::boxed::Box < dyn ::core::future::Future < Output = ::core::result::Result
        <$crate::LocatedChannelBindingSummaries, $crate::NativeChannelError >, > +
        ::core::marker::Send + 'a, >, > { ::std::boxed::Box::pin(self
        .locate_binding_summaries(context, input)) } fn binding_summary <'a > (&'a self,
        context : ::boxology::CallContext, input : $crate::BindingReference,) ->
        ::std::pin::Pin < ::std::boxed::Box < dyn ::core::future::Future < Output =
        ::core::result::Result <$crate::ChannelBindingSummary, $crate::NativeChannelError
        >, > + ::core::marker::Send + 'a, >, > { ::std::boxed::Box::pin(self
    ...
    (@ find_recover_session $receiver:ty; recover_session valid; $($rest:tt)*) => {
        const _ : () = { fn require_service < T : ::core::marker::Send +
        ::core::marker::Sync + 'static > () {} fn require_future < F :
        ::core::future::Future < Output = ::core::result::Result <$crate::ChannelBinding,
        $crate::NativeChannelError >> + ::core::marker::Send > (_ : F) {} fn
        check(receiver : &$receiver, context : ::boxology::CallContext, input :
        $crate::RecoverSessionRequest) { require_service::<$receiver > ();
        require_future(receiver.recover_session(context, input)); } };
    };
    (@ find_recover_session $receiver:ty; recover_session invalid; $($rest:tt)*) => {
        compile_error!("Boxology capability has an invalid structural signature");
    };
    (
        @ find_recover_session $receiver:ty; $other:ident $validity:ident; $($rest:tt)*
    ) => {
        $crate::__boxology_check_implementation!(@ find_recover_session $receiver;
        $($rest)*);
    };
    (@ find_recover_session $receiver:ty;) => {
        compile_error!("Boxology capability implementation is missing");
    };
    ...
    (@ find_list_binding_page $receiver:ty; list_binding_page valid; $($rest:tt)*) => {
        const _ : () = { fn require_service < T : ::core::marker::Send +
        ::core::marker::Sync + 'static > () {} fn require_future < F :
        ::core::future::Future < Output = ::core::result::Result
        <$crate::ChannelBindingCatalogPage, $crate::NativeChannelError >> +
        ::core::marker::Send > (_ : F) {} fn check(receiver : &$receiver, context :
        ::boxology::CallContext, input : $crate::ListChannelBindingPageRequest) {
        require_service::<$receiver > (); require_future(receiver
        .list_binding_page(context, input)); } };
    };
    (@ find_list_binding_page $receiver:ty; list_binding_page invalid; $($rest:tt)*) => {
        compile_error!("Boxology capability has an invalid structural signature");
    };
    (
        @ find_list_binding_page $receiver:ty; $other:ident $validity:ident; $($rest:tt)*
    ) => {
        $crate::__boxology_check_implementation!(@ find_list_binding_page $receiver;
        $($rest)*);
    };
    (@ find_list_binding_page $receiver:ty;) => {
        compile_error!("Boxology capability implementation is missing");
    };
    (
        @ find_locate_binding_summaries $receiver:ty; locate_binding_summaries valid;
        $($rest:tt)*
    ) => {
        const _ : () = { fn require_service < T : ::core::marker::Send +
        ::core::marker::Sync + 'static > () {} fn require_future < F :
        ...
        <$crate::LocatedChannelBindingSummaries, $crate::NativeChannelError >> +
        ::core::marker::Send > (_ : F) {} fn check(receiver : &$receiver, context :
        ::boxology::CallContext, input : $crate::LocateChannelBindingSummariesRequest) {
        require_service::<$receiver > (); require_future(receiver
        .locate_binding_summaries(context, input)); } };
    };
    (
        @ find_locate_binding_summaries $receiver:ty; locate_binding_summaries invalid;
        $($rest:tt)*
    ) => {
        compile_error!("Boxology capability has an invalid structural signature");
    };
    (
        @ find_locate_binding_summaries $receiver:ty; $other:ident $validity:ident;
        $($rest:tt)*
    ) => {
        $crate::__boxology_check_implementation!(@ find_locate_binding_summaries
        $receiver; $($rest)*);
    };
    (@ find_locate_binding_summaries $receiver:ty;) => {
        compile_error!("Boxology capability implementation is missing");
    };
